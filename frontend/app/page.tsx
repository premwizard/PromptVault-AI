...
const LandingNav = () => {
  ...
  return (
    <nav
      className={`fixed top-0 w-full z-50 transition-all duration-300 ${scrolled ? "bg-background/80 backdrop-blur-xl border-b border-white/10 py-3" : "bg-transparent py-5"}`}
    >
    ...
    <section className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden flex flex-col items-center text-center px-6">
      ...
      >
        ...
        <p className="text-lg md:text-xl text-white/60 max-w-2xl mx-auto mb-10 leading-relaxed">
          Stop losing your best prompts in chat histories. Save, organize, and
          reuse your most effective AI interactions in a secure, unified
          workspace built for professionals.
        </p>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Link href="/register">
            <Button
              size="lg"
              className="h-12 px-8 text-base bg-gradient-to-r from-accent-blue to-accent-purple text-white border-0 shadow-[0_0_30px_rgba(167,139,250,0.3)] hover:shadow-[0_0_40px_rgba(167,139,250,0.5)] hover:scale-105 transition-all"
            >
          ...
          <Link href="#showcase">
            <Button
              size="lg"
              variant="outline"
              className="h-12 px-8 text-base border-white/10 bg-white/5 hover:bg-white/10 backdrop-blur-md text-white"
            >
              View Product Tour
            </Button>
          </Link>
        ...
        <div className="mt-12 flex items-center justify-center gap-8 text-sm font-medium text-white/40">
          <div className="flex items-center gap-2">
            <CheckCircle2 className="w-4 h-4 text-accent-blue" /> No credit card
            required
          </div>
          <div className="flex items-center gap-2">
            <CheckCircle2 className="w-4 h-4 text-accent-purple" /> Free forever
            plan
          </div>
        </div>
      </motion.div>
  ...
  const features = [
    {
      ...
      description:
        "Categorize your prompts with collections, tags, and folders. Never lose a valuable interaction again.",
    },
    {
      icon: <Search className="w-6 h-6 text-accent-purple" />,
      title: "Lightning Fast Search",
      description:
        "Find exactly what you need in milliseconds. Search by content, title, model, or tags across your entire workspace.",
    },
    {
      icon: <Heart className="w-6 h-6 text-red-400" />,
      title: "Favorites & Quick Access",
      description:
        "Pin your most used prompts for instant access. Build a personalized toolkit of your highest-performing queries.",
    },
    {
      icon: <Zap className="w-6 h-6 text-yellow-400" />,
      title: "One-Click Copy",
      description:
        "No friction. Find your prompt, click once, and drop it directly into ChatGPT, Claude, or your tool of choice.",
    },
    {
      icon: <Shield className="w-6 h-6 text-emerald-400" />,
      title: "Private & Secure",
      description:
        "Your data is yours. Enterprise-grade encryption ensures your proprietary prompts remain completely confidential.",
    },
    {
      icon: <FolderOpen className="w-6 h-6 text-accent-cyan" />,
      title: "Dynamic Collections",
      description:
        "Group related prompts for specific projects, workflows, or clients. Keep your context completely separated.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <h2 className="text-3xl md:text-5xl font-bold mb-6">
            ...
            <span className="text-accent-purple">smarter</span>
          </h2>
          <p className="text-lg text-white/60">
            PromptVault is purposefully designed to remove friction from your AI
            workflows. Just the features you need, executed perfectly.
          </p>
        </div>
  ...
  const steps = [
    {
      num: "01",
      title: "Create & Refine",
      desc: "Craft your perfect prompt in your preferred AI tool.",
    },
    {
      num: "02",
      title: "Save to Vault",
      desc: "Store it with context, variables, and performance notes.",
    },
    {
      num: "03",
      title: "Organize",
      desc: "Tag and sort into relevant project collections.",
    },
    {
      num: "04",
      title: "Deploy Instantly",
      desc: "Find and copy with one click when you need it again.",
    },
  ];
      ...
      <div className="max-w-5xl mx-auto">
        <GlassCard className="relative overflow-hidden p-12 md:p-20 text-center border-accent-purple/30 bg-black/40">
          ...
          <p className="text-lg text-white/60 max-w-2xl mx-auto mb-10">
            Join thousands of professionals who have stopped losing their best
            prompts and started building a real AI knowledge base.
          </p>

          <Link href="/register">
            <Button
              size="lg"
              className="h-14 px-10 text-lg bg-white text-black hover:bg-white/90 hover:scale-105 transition-all shadow-[0_0_40px_rgba(255,255,255,0.2)]"
            >
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        <div className="col-span-1 md:col-span-2">
          ...
          <p className="text-white/50 max-w-sm mb-6">
            The professional workspace for saving, organizing, and deploying
            your most effective AI prompts.
          </p>
